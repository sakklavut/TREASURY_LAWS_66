...
<div class="container margin_search_results">
     <div class="row">
     ...
     <div class="row">
          <div class="col-xl-10 col-sm-10">
               <div class="row">
                    ...
                    <div class="col-sm-8">
                         <input class="form-control advance_me form_title" type="text" >
                    </div>
                    <div class="col-sm-2">
               ...
               <div class="row" style="display: none" id="myDIV0">
                    <div class="col-sm-2">
                         <select class="form-select form_title" aria-label="Default select example">
                              <label for="" class="name_title">ชื่อเรื่อง</label>
                                   <option selected>ชื่อเรื่อง</option>
               ...
               <div class="row" style="display: none" id="myDIV1">
                    <div class="col-sm-2">
                         <select class="form-select form_title" aria-label="Default select example">
                              <label for="" class="name_title">ชื่อเรื่อง</label>
                                   <option selected>ชื่อเรื่อง</option>
          ...
          <div class="col-xl-2 col-sm-2">
               <button class="btn btn_add mb-3 saveBtn"> 
                    <img src="icon/plus-solid_add_advace.svg" class="icon_add" alt="">
               </button>       
          </div>
     </div>
</div>
