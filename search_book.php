          ...
          <div class="col-12">
               <div class="d-flex box_all">
                    ...
                    <div class="box_search_results">
                         <h4 class="search_results">ผลการค้นหา</h4>
                    </div>
               </div>
          </div>
     </div>
     ...
     <div class="align-self-center">
          ...
          <div class="d-block">
                    ...
                    <form action="">
                         <div class="area_form">
                              ...
                              <div class="d-flex">
                                   ...
                                   <div class="col-xl-3 box_btn">
                                        <button type="submit" class="btn btn_advanced  mb-3" title="ค้นหาขั้นสูง">   <a href="advance_search.php" class="text_advanced"> ค้นหาขั้นสูง </a></button> 
                                   </div>
                              </div>
                         </div>
                    </form>
               ...
               <div class="d-flex justify-content-center tag_search">
                    ...
                    <div class="area_but_tag">
                         <button type="submit" class="btn btn_tag mb-3">หนังสื่อยอดนิยม 10 อันดับ</button>
                    </div>
                    <div class="area_but_tag">
                         <button type="submit" class="btn btn_tag mb-3">ภาพกิจกรรม</button>
                    </div>
               </div>
          </div>
     </div>
